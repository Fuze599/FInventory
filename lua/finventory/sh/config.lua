...
finventoryConfig.customItemsName = {
    ...
    gmod_camera = "Camera",
    manhack_welder = "Manhack Gun",
    weapon_medkit = "Medkit",
    gmod_tool = "Tool Gun",
    weapon_physgun = "Physic Gun",
    item_ammo_357 = "347 Ammo",
    item_ammo_357_large = "347 Ammo (Large)",
    ...
    npc_grenade_frag = "Zombine Grenade",
}
...
finventoryConfig.Language.tr = {
    ...
    dropItemSuccess = "Bir eşya bıraktınız!",
    pickupBoxSuccess = "Bir kutu aldınız!",
    pickupBackpackSuccess = "Bir sırt çantası aldınız!",
    pickupBackpackFailTooMuchItem = "Taşıdığınız eşyaları atın!",
    pickupBackpackFailAlreadyBack = "Mevcut sırt çantanızı bırakın!",
    dropBackpackSuccess = "Çantanızı bıraktınız!",
    buyBackpackSuccessDRP = "%d karşılığında bir sırt çantası satın aldınız" .. finventoryConfig.currency .. "!",
    buyBackpackSuccess = "Yeni bir sırt çantası satın aldınız!",
    notEnoughMoney = "Yeterince paranız yok!",
    tooFarFromPerson = "Kişiye çok uzaksınız!",
    notAllowed = "Bunu yapmaya yetkiniz yok!",
    removedItemInspector = "%d illegal eşyayı kaldırdınız!",
    removedItemInspectorMoney = "%d illegal eşyayı, %d karşılığında kaldırdınız" .. finventoryConfig.currency .. "!",
    removedItemSuspect = "%d eşyaya el konuldu!",
    inventory = "Envanter",
    searchInventory = "Envanteri ara",
    dropBackpack = "Çantayı bırak",
    removeIllegalItems = "İllegal Eşya Kaldır",
    bank = "Banka",
    bought = "Satın Alınan",
    buy = "Satın Al",
    vendor = "Çanta satıcı",
    ...
    searchPlayer = " Bir oyuncuyu ara",
    allInventories = "Tüm envanterler",
    job = "Meslek : ",
    bag = "Çanta : ",
